...
contains
    ...
    function integrate_wrapper(func, a, b, intsteps) result(integral) bind(C)
        use iso_c_binding

        abstract interface
            real(c_float) function integrad (x) bind(c)
        ...
        procedure(integrad), pointer    :: func
        real   (c_float), value         :: a, b
        integer(c_int)  , value         :: intsteps
